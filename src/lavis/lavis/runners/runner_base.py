    ...
    def dataloaders(self) -> dict:
        ...
        if self._dataloaders is None:
            ...
            for split_name in self.datasets:
                ...
                else:  # [NOTEME] modify to incorparate chaindataset (multiple webdataset)
                    if not isinstance(
                        self.datasets[split_name], ChainDataset
                    ) and hasattr(self.datasets[split_name], "__len__"):
                        # a single map-style dataset
                        num_records = len(self.datasets[split_name])
                    else:
                        # # a single wds.DataPipeline
                        num_records = -1
                        logging.info("wds.DataPipeline dataset, no __len__ attribute.")
                        # logging.info(
            ...
            # [NOTEME] modify for webdataset
            is_webdataset = [
                isinstance(self.datasets[split_name], ChainDataset)
