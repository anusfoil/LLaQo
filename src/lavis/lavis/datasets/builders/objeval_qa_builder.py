...
from lavis.datasets.datasets.objeval_qa import ObjevalDatasetQA


@registry.register_builder("objeval_qa")
class ObjevalQABuilder(BaseDatasetBuilder):
    train_dataset_cls = ObjevalDatasetQA
    eval_dataset_cls = ObjevalDatasetQA

    DATASET_CONFIG_DICT = {"default": "configs/datasets/objeval_qa/defaults.yaml"}
