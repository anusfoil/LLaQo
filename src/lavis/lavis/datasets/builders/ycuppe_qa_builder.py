...
from lavis.datasets.datasets.ycuppe_qa import YCUPPEDatasetQA


@registry.register_builder("ycuppe_qa")
class YCUPPEQABuilder(BaseDatasetBuilder):
    train_dataset_cls = YCUPPEDatasetQA
    eval_dataset_cls = YCUPPEDatasetQA

    DATASET_CONFIG_DICT = {"default": "configs/datasets/ycuppe_qa/defaults.yaml"}
