...
from lavis.datasets.datasets.playdata_qa import PlaydataDatasetQA


@registry.register_builder("playdata_qa")
class PlaydataQABuilder(BaseDatasetBuilder):
    train_dataset_cls = PlaydataDatasetQA
    eval_dataset_cls = PlaydataDatasetQA

    DATASET_CONFIG_DICT = {"default": "configs/datasets/playdata_qa/defaults.yaml"}
