...
from lavis.datasets.datasets.cipi_qa import CIPIDatasetQA


@registry.register_builder("cipi_qa")
class CIPIQABuilder(BaseDatasetBuilder):
    train_dataset_cls = CIPIDatasetQA
    eval_dataset_cls = CIPIDatasetQA

    DATASET_CONFIG_DICT = {"default": "configs/datasets/cipi_qa/defaults.yaml"}
