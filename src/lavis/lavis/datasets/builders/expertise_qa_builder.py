...
from lavis.datasets.datasets.expertise_qa import ExpertiseDatasetQA


@registry.register_builder("expertise_qa")
class ExpertiseQABuilder(BaseDatasetBuilder):
    train_dataset_cls = ExpertiseDatasetQA
    eval_dataset_cls = ExpertiseDatasetQA

    DATASET_CONFIG_DICT = {"default": "configs/datasets/expertise_qa/defaults.yaml"}
