...
from lavis.datasets.datasets.pisa_qa import PISADatasetQA


@registry.register_builder("pisa_qa")
class PISAQABuilder(BaseDatasetBuilder):
    train_dataset_cls = PISADatasetQA
    eval_dataset_cls = PISADatasetQA

    DATASET_CONFIG_DICT = {"default": "configs/datasets/pisa_qa/defaults.yaml"}
