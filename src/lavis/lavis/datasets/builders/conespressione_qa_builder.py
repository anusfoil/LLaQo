...
from lavis.datasets.datasets.conespressione_qa import ConEspressioneDatasetQA
...
class ConEspressioneQABuilder(BaseDatasetBuilder):
    ...
    DATASET_CONFIG_DICT = {"default": "configs/datasets/conespressione_qa/defaults.yaml"}
