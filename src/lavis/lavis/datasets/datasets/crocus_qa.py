...
ANSWERS_CSV = '/data/EECS-MachineListeningLab/datasets/LLaQo/crocus/evaluation_qa.csv'
AUDIO_DIR = '/data/EECS-MachineListeningLab/datasets/LLaQo/crocus/Performance_Records'

class CROCUSDataset(Dataset):
    """CROCUS dataset."""
    ...
    def __getitem__(self, idx):
        ...
        audio_path = os.path.join(self.audio_dir,
                                self.audio_qa['audio_file'].iloc[idx])
