...
# def extend_instance(obj, ext_class):
#     r"""Apply mixins to a class instance after creation"""
#     base_cls = obj.__class__
#     base_cls_name = obj.__class__.__name__
#     obj.__class__ = type(base_cls_name, (ext_class, base_cls), {})
...
class SWIFT(LAMBase):
    ...
    def extend(cls, model_obj, ckpt_path):
        ...
        model_obj.init_swift()
        model_obj.load_checkpoint(ckpt_path)

        model_obj.audio_processor = _fbankProcessor.build_processor({})
...
if __name__ == "__main__":
    ...
    categories = {int(r["index"]): r["display_name"] for _, r in df.iterrows()}
    ...
    dump_pickle(categories_tokens,
                "/data/home/acw630/WORKPLACE/LAM/engine/categories.pickle")
